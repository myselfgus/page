...
export default function AboutSection() {
  ...
  const [visualRef, visualInView] = useScrollAnimation()
      ...
      <div className="section-container max-w-6xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  mental. Nossa missão é empoderar profissionais e pacientes com ferramentas que transcendem as
                  limitações dos sistemas categoriais tradicionais, oferecendo uma compreensão mais profunda e
                  personalizada do sofrimento psíquico.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  representa uma revolução na forma como avaliamos e tratamos a saúde mental. Fundamentada nos
                  princípios do materialismo existencial, nossa abordagem integra elementos da fenomenologia da
                  corporalidade e do existencialismo situado.
                </p>
          ...
          <ParallaxSection offset={50}>
            ...
            >
              <motion.div
                className="bg-pearl rounded-lg p-6 shadow-md"
                whileHover={{
                  y: -5,
              ...
              <motion.div
                className="flex items-center bg-gradient-to-r from-emotional-dark to-autonomy-dark text-white rounded-lg p-4 shadow-md"
                whileHover={{
                  y: -5,
                  boxShadow: "0 10px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04)",
                }}
              ...
              <motion.div
                className="bg-gradient-to-r from-cognitive-dark to-cognitive-light text-white rounded-lg p-6 shadow-md"
                whileHover={{
                  y: -5,
                  boxShadow: "0 10px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04)",
                }}
              ...
              >
                ...
                <p className="mb-0">
                  Nossa equipe combina expertise em psiquiatria, neurociência, IA e engenharia de software com uma
                  paixão por resolver desafios complexos em saúde mental.
                </p>
              </motion.div>
            </motion.div>
          </ParallaxSection>
